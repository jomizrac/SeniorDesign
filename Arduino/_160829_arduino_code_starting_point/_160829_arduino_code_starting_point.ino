...
/*
 * Prints a char to the Serial console that the C code reads and plays that vid
 */
...
/*
 * works with prox sensors. havent gotten that far yet
 */
void detect_person()
{
...
/*
 * sequentially flashes the leds of all products
 */
void flash_facing()
{
play_facing(9);
